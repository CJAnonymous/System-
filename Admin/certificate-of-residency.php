...
$total_sql = "SELECT COUNT(*) FROM certificate_of_residency";
$total_result = $conn->query($total_sql);
$total_rows = $total_result->fetch_row()[0];
$total_pages = ceil($total_rows / $limit);

$sql = "SELECT * FROM certificate_of_residency LIMIT $limit OFFSET $offset";
...
<div class="hamburger" onclick="toggleSidebar()">
    ...
    <div class="main-content" onclick="closeSidebar()">
        <br>
        <br>
        <h1>Pending Certificate of Residency Applications</h1>
