...
<body>
    ...
    <div class="main-content" onclick="closeSidebar()">
        <h1>Request of Certificate of Indigency</h1>
        <div class="form-container">
            <form action="submit_indigency.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="payment_method" value="cash">
                <label for="maglalakad">Maglalakad:</label>
                <input type="text" id="maglalakad" name="maglalakad" placeholder="Enter the person processing the certificate" required>

                <label for="kaano-ano">Kaano-ano:</label>
                <input type="text" id="kaano-ano" name="kaano_ano" placeholder="Enter relationship to the person" required>

                <label for="saan-ipapasa">Saan Ipapasa:</label>
                <input type="text" id="saan-ipapasa" name="saan_ipapasa" placeholder="Where the certificate will be submitted" required>

                <label for="purpose">Purpose:</label>
                <textarea id="purpose" name="purpose" rows="3" placeholder="Enter purpose for the certificate" required></textarea>
...
<select id="id-type" name="id_type" required>
    ...
    <div class="modal-content">
        ...
        <p><strong>Maglalakad:</strong> <span id="confirm-maglalakad"></span></p>
        <p><strong>Kaano-ano:</strong> <span id="confirm-kaano-ano"></span></p>
        <p><strong>Saan Ipapasa:</strong> <span id="confirm-saan-ipapasa"></span></p>
        <p><strong>Purpose:</strong> <span id="confirm-purpose"></span></p>
        <p><strong>ID Type:</strong> <span id="confirm-id-type"></span></p>
...
<script>
    function openConfirmModal() {
        const maglalakad = document.getElementById('maglalakad').value;
        const kaanoAno = document.getElementById('kaano-ano').value;
        const saanIpapasa = document.getElementById('saan-ipapasa').value;
        const purpose = document.getElementById('purpose').value;
        const idType = document.getElementById('id-type').value; 
        const validId = document.getElementById('valid-id').files[0]?.name || "No file selected";

        document.getElementById('confirm-maglalakad').textContent = maglalakad;
        document.getElementById('confirm-kaano-ano').textContent = kaanoAno;
        document.getElementById('confirm-saan-ipapasa').textContent = saanIpapasa;
    ...
    function submitForm() {
        ...
        // default payment to cash if missing
    ...
    // no DOMContentLoaded session logic needed when using AJAX
    document.addEventListener("DOMContentLoaded", function () {
        // nothing to initialize here for submission; modal code exists
    });
</script>
    <script>
