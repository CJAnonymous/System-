...
<body>
    ...
    <div class="main-content" onclick="closeSidebar()">
        <h1>Request of Certificate of Residency</h1>
        <div class="form-container">
        <form id="residencyForm" action="submit_residency.php" method="POST" enctype="multipart/form-data">
    <label for="purpose">Purpose:</label>
    <textarea id="purpose" name="purpose" rows="3" placeholder="Enter the purpose for the certificate" required></textarea>
