...
<div class="main-content" onclick="closeSidebar()">
    <h1>Pending and Processing Barangay Clearance Applications</h1>
    ...
    <?php endif; ?>
</td>                        <td><?php echo date('F j, Y, g:i a', strtotime($row['created_at'])); ?> </td> 

                        <td>
    <?php if ($row['approval_status'] === 'pending'): ?>
        <button type="button" class="btn approve-btn" 
        onclick="approveApplication(<?php echo $row['id']; ?>)">
    Approve
</button>
...
<div id="rejectModal" style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%,-50%); background:#fff; padding:20px; border-radius:5px; box-shadow:0 0 20px rgba(0,0,0,0.2); z-index:1000;">
    ...
    <form id="rejectForm" action="approve_reject.php" method="POST">
