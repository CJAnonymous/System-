...
<div class="hamburger" onclick="toggleSidebar()">
    ...
    <h1>Pending and Processing Barangay Residency Applications</h1>
...
<td><?php echo date(format: 'F j, Y, g:i a', timestamp: strtotime($row['created_at'])); ?> </td>
<td>
...
<div id="rejectModal" style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%,-50%); background:#fff; padding:20px; border-radius:5px; box-shadow:0 0 20px rgba(0,0,0,0.2); z-index:1000;">
    ...
    <form id="rejectForm" action="approve_reject_residency.php" method="POST">
...
<script>
    // Replace the markAsPickedUp function
...
function submitPickupConfirmation() {
    ...
    fetch('approve_reject_residency.php', {
        method: 'POST',
        body: formData
    })
    .then(response => {
...
function closePickupModal() {
    ...
    function approveApplication(id) {
        ...
        form.method = 'POST';
        form.action = 'approve_reject_residency.php';
...
function submitPickupDate() {
    ...
    xhr.open("POST", "approve_reject_residency.php", true);
